			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form  action="<?php echo site_url()?>yearbook/add_yearbook_data" method="post" enctype="multipart/form-data"> 
								<div class="form-group"> 
									<label for="exampleInputEmail1">Yearbook Name</label> 
									<input type="text" class="form-control" id="" name="book_name" placeholder="Name" required="" > 
									
								</div> 
								<div class="form-group"> 
									<label for="exampleInputEmail1">Year</label> 
									<input type="text" class="form-control" id="" name="book_year" placeholder="Year" required="" > 
									
								</div> 
								<div class="form-group"> 
									<label for="exampleInputEmail1">Yearbook Description</label> 
									<textarea class="form-control" id="" name="book_description"  required="" > 	</textarea>								
								</div>
								<div class="form-group col-12">
									<label>Yearbook Image</label>
									<input type="file" name="yearbookimg" required>
								</div>
								 <div class="form-group col-12">
									<label>University logo</label>
									<input type="file" name="uni_logo" id="uni_logo" required>
								</div>
								<div class="form-group"> 
									<label for="exampleInputEmail1">University Text</label> 
									<input type="text" class="form-control" id="" name="uni_text" placeholder="Enter Text" required="" > 									
								</div>
								<div class="form-group"> 
									<label for="exampleInputEmail1">CEO/Director Name</label> 
									<input type="text" class="form-control" id="" name="ceo_name" placeholder="Enter Name" required="" > 									
								</div>
								<div class="form-group"> 
									<label for="exampleInputEmail1">CEO Designation</label> 
									<input type="text" class="form-control" id="" name="ceo_designation" placeholder="Enter Designation" required="" > 									
								</div>
								<div class="form-group"> 
									<label for="exampleInputEmail1">CEO Quote</label> 
									<textarea class="form-control" id="" name="ceo_quote" placeholder="Enter Quote" required="" > 	</textarea>								
								</div>
								 <div class="form-group col-12">
									<label>CEO Image</label>
									<input type="file" name="ceoimg" id="ceoimg" required>
								</div>
