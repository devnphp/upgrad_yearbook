			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form  action="<?php echo site_url()?>faculty/edit_faculty_data" method="post" enctype="multipart/form-data"> 
								<div class="form-group"> 
									...
									<option value="">Select Yearbook</option> 
										<?php foreach($books as $book) { ?>
                                         <option value="<?php echo $book['id'];?>" <?php if($book['id']==$faculty['yearbook_id']) echo "selected";?>><?php echo $book['yearbook_name'];?></option>
                                         <?php } ?>
									</select>
								...
								<div class="form-group"> 
									...
									<input type="text" class="form-control" id="" name="faculty_name" placeholder="Faculty Name" required="" value="<?php echo $faculty['faculty_name']?>"> 
									<input type="hidden" name="editid" value="<?php echo $editid ;?>">									
								</div>
								<div class="form-group"> 
									<label for="exampleInputEmail1">Faculty Designation</label> 
									<input type="text" class="form-control" id="" name="faculty_designation" placeholder="Faculty Designation" required="" value="<?php echo $faculty['faculty_designation']?>"> 									
								</div>
								<div class="form-group"> 
									<label for="exampleInputEmail1">Faculty Quote</label> 
									<textarea class="form-control" id="" name="faculty_quote" placeholder="Faculty Quote" required="" ><?php echo $faculty['faculty_quote']?> </textarea>									
								</div>
								 <div class="form-group col-12">
									<label>Faculty Image</label>
									<input type="file" name="facultyimg" id="facultyimg" >
									<input type="hidden" name="old_facultyimg" value="<?php echo $faculty['faculty_image']?>" >

									<img src="<?php echo base_url('uploads/faculty/'.$faculty['faculty_image']) ;?>" width="200">
								</div>
