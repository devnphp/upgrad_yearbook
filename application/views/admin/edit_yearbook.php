			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form  action="<?php echo site_url()?>admin/yearbook/edit_yearbook_data" method="post" enctype="multipart/form-data"> 
								...
								<div class="form-group"> 
									...
									<input type="text" class="form-control" id="" name="book_year" placeholder="Name" required="" value="<?php echo $book['yearbook_year']?>" > 
									<input type="hidden" name="editid" value="<?php echo $editid ;?>">
								</div>
								<div class="form-group"> 
									<label for="exampleInputEmail1">Yearbook Description</label> 
									<textarea class="form-control" id="" name="book_description" required="" > <?php echo $book['yearbook_description']?>	</textarea>								
								</div>
								 <div class="form-group col-12">
									<label>Yearbook Image</label>
									<input type="file" name="yearbookimg">
									<input type="hidden" name="old_yearbookimg" value="<?php echo $book['yearbook_image'] ;?>">
									<img src="<?php echo base_url('uploads/yearbook/'.$book['yearbook_image']) ;?>" width="200">
								</div>
								 <div class="form-group col-12">
									<label>University logo</label>
									<input type="file" name="uni_logo" id="uni_logo">
									<input type="hidden" name="old_uni_logo" value="<?php echo $book['university_logo'] ;?>">
									<img src="<?php echo base_url('uploads/yearbook/'.$book['university_logo']) ;?>" width="200">
								</div>
								<div class="form-group"> 
								...
								<div class="form-group"> 
								 ...
								 <div class="form-group col-12">
									...
									<img src="<?php echo base_url('uploads/yearbook/'.$book['ceo_image']) ;?>" width="200">
								</div>
