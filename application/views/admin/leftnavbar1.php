          ...
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="index.html">
              ...
              <?php  $sessiontrue=$this->session->userdata();?>
                            <img src="<?php echo base_url().'settingpic/'.$sessiontrue=$this->session->userdata('logo');?>" style="width:170%; height: 120%;"/></span>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
               ...
               <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    ...
                    <i class="fa fa-angle-right"></i>Social Medias
                    </a>
                  </li>
              ...
              <li class="treeview">
                ...
                <li class="treeview">
                <a href="<?php echo site_url("attrib")?>">
                <i class="glyphicon glyphicon-th-list"></i>
                <span>Manage Attrib</span>
              
                </a>
              </li>
               <li class="treeview">
                <a href="<?php echo site_url("Faq/view_faq")?>">
             ...
             <!--  <li class="treeview">
               ...
               <li class="treeview">
                ...
                <li class="treeview">
                <a href="<?php echo site_url("Blog/view_blog")?>">
                <i class="glyphicon glyphicon-th-list"></i>
